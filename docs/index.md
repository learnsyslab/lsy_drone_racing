...
Learn about the [drone racing challenge](challenge/overview.md), including details on the [simulation environment](challenge/simulation.md), [real-world deployment](challenge/deployment.md), and the [online competition](challenge/online_competition.md).
...
- [Drone Control](control/index.md)
- [Racing Environments](envs/index.md)
